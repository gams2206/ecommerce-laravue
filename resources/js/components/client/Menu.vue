<template>
    <nav>
        <div class="black text-white d-flex justify-content-around align-items-center">
            <p class="d-inline m-1"><i class="bi bi-box-seam"></i> Envio Grátis Para Todo o Brasil</p>
